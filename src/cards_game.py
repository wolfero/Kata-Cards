class CardGame:
    ...
    def whoWins(self, player1Hand: list, player2Hand: list) -> str:
        player1Value = self.getCardsValue(player1Hand.__getitem__(0), player1Hand.__getitem__(1))
        player2Value = self.getCardsValue(player2Hand.__getitem__(0), player2Hand.__getitem__(1))
